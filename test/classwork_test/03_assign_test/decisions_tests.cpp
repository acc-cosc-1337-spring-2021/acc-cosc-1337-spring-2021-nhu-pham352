...
TEST_CASE("Test convert numerial grade to a letter grade using if function")
{
...
TEST_CASE("Test convert numerial grade to a letter grade using switch function")
{
